    ...
    DiscreteLocation a_idle)
{
    ...
    // 3.Registration of input/output internal events
     DiscreteEvent e_a_idle("a1_idle");
    ...
    // 4.Registration of locations
     DiscreteLocation a_opening("a1_opening");
     DiscreteLocation a_closing("a1_closing");
    ...
    DiscreteLocation a_idle)
{
    ...
    // 3.Registration of input/output internal events
     DiscreteEvent e_a_idle("a2_idle");
    ...
    // 4.Registration of locations
     DiscreteLocation a_opening("a2_opening");
     DiscreteLocation a_closing("a2_closing");

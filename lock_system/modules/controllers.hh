...
controller.add_output_event(e_a2_close);
  ...
  controller.new_unforced_transition(e_a1_close, on_first, on_second, z1_geq_hmax1);
  controller.new_unforced_transition(e_a2_open, on_first, on_second, z1_geq_hmax1);
  
  controller.new_unforced_transition(e_a2_close, on_second, out_lock, z2_geq_hmax2);
  controller.new_unforced_transition(e_a2_close, out_lock, on_first, z2_leq_hmin2);

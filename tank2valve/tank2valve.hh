...
//            tank.new_mode(stormy);
			...
			o_valve.new_forced_transition(e_o_idle, o_opening, o_idle, rst_w_one, w_geq_one);
			o_valve.new_forced_transition(e_o_idle, o_closing, o_idle, rst_w_zero, w_leq_zero);

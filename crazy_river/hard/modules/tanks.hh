    ...
    DiscreteLocation S0)
{
    ...
    crazy_river.set_dynamics(S0, z2, -alpha2 * z2 - gamma2 * z2 + beta2 * a * z4 + alpha1 * z1);
    crazy_river.set_dynamics(S0, z3, -gamma3 * z3 + beta3 * a * z4 + alpha2 * z2);
    ...
    crazy_river.set_dynamics(S1, z2, -alpha2 * z2 - gamma2 * z2 + beta2 * a * z4 + (beta1 * a * z4 + alpha1 * z1 - gamma1 * z1));
    crazy_river.set_dynamics(S1, z3, -gamma3 * z3 + beta3 * a * z4 + alpha2 * z2);
    ...
    crazy_river.set_dynamics(S2, z3, -gamma3 * z3 + beta3 * a * z4 + (beta2 * a * z4 + alpha2 * z2 - gamma2 * z2 + alpha1 * z1 + beta1 * a * z4 - gamma1 * z1));
    ...
    crazy_river.set_dynamics(S3, z2, -alpha2 * z2 + beta2 * a * z4 - gamma2 * z2 + alpha1 * z1);
    ...
    crazy_river.set_dynamics(S4, z3, -gamma3 * z3 + beta3 * a * z4 + alpha2 * z2 - gamma2 * z2 + beta2 * a * z4 + alpha1 * z1 + beta1 * a * z4 - gamma1 * z1);
    ...
    crazy_river.set_dynamics(S5, z2, -alpha2 * z2 + beta2 * a * z4 + (beta1 * a * z4 - gamma1 * z1 + alpha1 * z1) - gamma2 * z2);
    ...
    RealExpression guard_d = H1 - z1; //!< z<=beta*a
    RealExpression guard_b = z2 - H2; //!< z>=H
    RealExpression guard_e = H2 - z2; //!< z<=beta*a
    RealExpression guard_c = z3 - H3; //!< z>=H
    RealExpression guard_f = H3 - z3; //!< z<=beta*a

...
int main(int argc, char **argv)
{
    ...
    HybridIOAutomaton system = Ariadne::getSystem(0.08,0.1,0.26,0.16,0.1,0.3,0.3,0.2);

    cout << system << endl;

    HybridBoundedConstraintSet initial_set(system.state_space());
    initial_set[DiscreteLocation("S0,idle,falling")] = Box(5, 0.0,0.0,1.0,2.0, 1.0, 2.0, 1.0, 2.0, 1.0, 2.0);
